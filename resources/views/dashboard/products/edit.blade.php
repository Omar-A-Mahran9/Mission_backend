...
@section('content')
    ...
    <div id="kt_app_content" class="app-content">
        ...
        <form action="{{ route('dashboard.products.update', $product) }}"
            data-redirection-url="{{ route('dashboard.products.index') }}" id="kt_ecommerce_add_product_form"
            class="form d-flex flex-column flex-lg-row ajax-form" method="POST">
            @method('put')
            <!--begin::Main column-->
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">{{ __('Edit Product') }}</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <input type="text" name="name_ar" id="name_ar_inp"
                                        ...
                                        placeholder="{{ __('Write the product name in Arabic') }}"
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <input type="text" class="form-control form-control-solid mb-2"
                                        ...
                                        id="name_en_inp" value="{{ $product->name_en }}" />
                                    <!--end::Input-->
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <textarea class="form-control form-control-lg form-control-solid mb-3" rows="1" name="description_ar"
                                        id="description_ar_inp" data-kt-autosize="true" placeholder="{{ __('Write the description in Arabic') }}">{{ $product->description_ar }}</textarea>
                                    <!--end::Editor-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <textarea class="form-control form-control-lg form-control-solid mb-3" name="description_en" id="description_en_inp"
                                        rows="1" data-kt-autosize="true" placeholder="{{ __('Write the description in English') }}">{{ $product->description_en }}</textarea>
                                    <!--end::Editor-->
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <input type="text" name="minimum_bid" step="0.1" min="1"
                                        ...
                                        placeholder="{{ __('Write the minimum bidders') }}"
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text"step="0.1" min="1" name="product_price"
                                        id="product_price_inp"
                                        class="form-control form-control-solid mb-2 no-arrow numeric-input"
                                        placeholder="{{ __('Write the basic product price') }}"
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text"step="0.1" min="1" name="start_price"
                                        id="start_price_inp"
                                        class="form-control form-control-solid mb-2 no-arrow numeric-input"
                                        placeholder="{{ __('Write the opening product price') }}"
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text"step="0.1" min="1" name="bid_price"
                                        class="form-control form-control-solid mb-2 no-arrow numeric-input"
                                        id="bid_price_inp"
                                        placeholder="{{ __('Write the bidding price for the product') }}"
                                        value="{{ $product->bid_price }}" />
                                    <!--end::Input-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text"step="0.1" min="1" name="ticket_price"
                                        id="ticket_price_inp"
                                        class="form-control form-control-solid mb-2 no-arrow numeric-input"
                                        placeholder="{{ __('Write the ticket price for the product') }}"
                                        value="{{ $product->ticket_price }}" />
                                    <!--end::Input-->
                            ...
                            <div class="d-flex flex-wrap gap-5" style="margin-top: 27px;">
                                <div class="fv-row w-100 flex-md-root">
                                    <input type="text" hidden name='deletedVariations[]' id='deletedVariationsInput'>
                                    <!--begin::Repeater-->
                                    <div id="variations">
                                        <!--begin::Form group-->
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <input type="number" name="id"
                                                                    value="{{ $bidding['id'] }}" style="display:none">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="{{ $bidding['bidding_discount_percentage'] }}" />
                                                                    <!--end::Input-->
                                                                ...
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="{{ $bidding['final_bidding_percentage'] }}" />
                                                                    <!--end::Input-->
                                                                    <div class="fv-plugins-message-container invalid-feedback"

                                ...
                                <div class="card-header">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input" name="hidden_flag" type="checkbox"
                                                value="1" {{ $product->hidden_flag == 1 ? 'checked' : '' }}
                                    ...
                                    <div class="d-flex flex-column flex-md-row gap-5">
                                        ...
                                        <div class="fv-row flex-row-fluid">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2"
                                                ...
                                                <option value="">{{ __('Choose the vendor') }}</option>
                                        ...
                                        <div id="variations">
                                                                ...
                                                                <div class="d-flex flex-column flex-md-row gap-5">
                                                                    ...
                                                                    <div class="fv-row flex-row-fluid">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            min="1"onchange="handleInputChange()"
                                                                    ...
                                                                    <div class="fv-row flex-row-fluid">
                                                                        <label
                                                                            class="required form-label">{{ __('Profit amount') }}</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid no-arrow size_inp"
                                                                            ...
                                                                            name="manufacturing_profit_price"
                                                                            value="{{ $specification->manufacturing_profit_price }}"
                                                                            id="manufacturing_profit_price_inp" required
                                                                            placeholder="{{ __('Profit amount') }}" />
                                                                        <!--end::Input-->
                                                                        <div class="fv-plugins-message-container invalid-feedback"
                                                                            id="manufacturing_profit_price">
                                                                        </div>
                                                                    </div>
                                                                    <div class="fv-row flex-row-fluid " id="total_div"
                                                                        style="display: none;">
                                                                        <label class="form-label"
                                                                            id='total_title'>{{ __('Total including profit and tax') }}</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid no-arrow size_inp"
                                                                            name="total" type="text" id="total_inp"
                                                                            readonly />
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <div class="fv-row flex-row-fluid">
                                                                        <!--begin::Label-->
                                                                        <label
                                                                            class="form-label">{{ __('Price after discount') }}</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid no-arrow size_inp"
                                                                            ...
                                                                            placeholder="{{ __('price after discount') }}" />
                                                                        <!--end::Input-->
                                                                        <div class="fv-plugins-message-container invalid-feedback"
                                                                            id="discount_price">
                                                                        </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="d-flex flex-column flex-md-row gap-5">
                                                                    ...
                                                                    <div class="fv-row flex-row-fluid " id="total_div"
                                                                        style="display: none;">
                                                                        <label
                                                                            class="required form-label">{{ __('Total') }}</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid no-arrow size_inp"
                                            ...
                                            <div class="form-group mt-5" id='add_dev'>
                                                <a href="javascript:;" data-repeater-create
                                                    class="btn {{ setting('theme_mode') == 'light' ? 'btn-light-primary' : 'btn-light' }}">
    ...
    <script>
        ...
        function calculateGramPrice() {
            ...
            */
            ...
            const selectedSubCategoryIdRepeate = subcategoriesSelect.value;
            const selectedSubCategory = subCategories.find(subCategory => subCategory.id ==
                selectedSubCategoryIdRepeate);
            let result = 0;
            repeaterItems.forEach((item, index) => {
                ...
                const manufacturingProfitPriceInput = item.querySelector(
                    `input[id="variations_${index}_manufacturing_profit_price_inp"]`);
                const totalInput = item.querySelector(
                    `input[id="variations_${index}_total_inp"]`);
                ...
                const totalDev = $(item).find('#total_div');
                const profit = parseFloat(manufacturingProfitPriceInput.value) || 0;
                let price = parseFloat(priceInput.value) || 0;
                {{--  if (selectedCategory.tax_applicable == 1) {
                    document.getElementById("total_title").innerHTML = __('Total including profit');
                }  --}}
                ...
                if (selectedCategoryId == 5) {
                    const alloyResult = searchKey(alloyGramsPrices, keyToSearch);
                    var materialResult = alloyResult;
                } else {
                    var materialResult = goldResult ||
                        silverResult; // Use goldResult if it exists; otherwise, use silverResult
                }
                if (materialResult) {
                    if (priceInput.value == 0) {
                        price = weight * materialResult.value;
                        priceInput.value = price;
                    }
                    result = selectedCategory.tax_applicable === 1 ?
                        (price + profit) * (1 + tax / 100) :
                        (price + profit);
        ...
        function handleInputChange() {
            ...
            if (selectedCategory && product.subcategories_new[0].id != selectedSubCategory.id) {
                ...
                document.getElementById('name_en_inp').value = product.name_en;
            }
        }
    </script>
        ...
        $(document).ready(function() {
            ...
            $('#categories_inp').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#subcategories_inp').empty();
                        const options =
                            `<option value="" selected disabled>${__("Choose the subcategories")}</option>` +
                            data.sub.map((subcategory) => {
                                const isSelected = Array.isArray(selectedSubCategories) ?
                                    selectedSubCategories.includes(String(subcategory.id)) :
                                    String(subcategory.id) === String(
                                        selectedSubCategories);

                                return `<option value="${subcategory.id}" ${isSelected ? "selected" : ""}>${subcategory.name}</option>`;
                            }).join('');

                        $('#subcategories_inp').html(options);

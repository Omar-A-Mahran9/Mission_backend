                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                            ...
                                            <input class="form-check-input" name="hidden_flag" type="checkbox"
                                                value="1"
                                                id="kt_modal_update_address_billing"@checked(true)>
                                            <!--end::Input-->
                                        </label>
                                        <!--end::Switch-->
                                    </div>
                                            ...
                                            <div class="fv-row flex-row-fluid">
                                                ...
                                                <select class="form-select form-select-solid product_name_comination_class"
                                                    ...
                                                    @foreach ($categories as $categroy)
                                                        <option value="{{ $categroy->id }}"> {{ $categroy->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <!--end::Select2-->
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                ...
                                                                <div class="fv-row flex-row-fluid " id="total_div"
                                                                    style="display: none;">
                                                                    <label
                                                                        class="required form-label">{{ __('Total including profit and tax') }}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input
                                                                        class="form-control form-control-lg form-control-solid no-arrow size_inp"
...
@push('scripts')
    <script>
        ...
        var alloyGramsPrices = @json($alloyGramsPrices);
        ...
        function calculateGramPrice() {
            ...
            */
            ...
            repeaterItems.forEach((item, index) => {
                ...
                if (weightInput && priceInput) { // Check if inputs are not empty
                    ...
                    if (materialResult) {
                        ...
                        // If neither goldResult nor silverResult is found
                        result = selectedCategory.tax_applicable === 1 ?
                            (price + profit) * (1 + tax / 100) :
                            (price + profit);

            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                    ...
                    @if ($order->paying_off == 1)
                        {{--  @dd($order->status)  --}}
                        @if (App\Enums\OrderStatus::Shipped->name == $order->status_name)
                        ...
                        @elseif(App\Enums\OrderStatus::PaymentConfirmed->name == $order->status_name)
                            <form action="{{ route('dashboard.change-order-status', $order->id) }}" method="POST">
                                @csrf
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    <i class="fa-solid fa-hashtag fs-4 me-2"></i> {{ __('Serial no') }}
                                                </div>
                                            </td>
                                            <td class="fw-bold text-end">{{ $order->serial_no }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end"><span
                                                    class="badge badge-primary">{{ __('' . $order->status_name) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                        ...
                                        @if ($order->paying_off != '1')
                                            <tr>
                                                <td class="text-muted">
                                                    <div class="d-flex align-items-center">
                                                        <i
                                                            class="fa-solid fa-credit-card fs-4 me-2"></i>{{ __('Type payment method') }}
                                                    </div>
                                                </td>
                                                <td class="fw-bold text-end">
                                                    {{ $order->payment_method ? __("$order->payment_method") : '--' }}
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="kt_ecommerce_sales_order_summary" role="tab-panel">
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            @if (App\Enums\OrderStatus::Canceled->name == $order->status_name ||
                                    App\Enums\OrderStatus::Refund->name == $order->status_name)
                                <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                    <!--begin::Reason status-->
                                    <div class="card card-flush py-4 flex-row-fluid position-relative">
                                        <!--begin::Background-->
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-dark fs-3 fw-bolder text-end">
                                                        {{ $subTotal + $order->shipping_price . __(' Ryal Saudi') }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>

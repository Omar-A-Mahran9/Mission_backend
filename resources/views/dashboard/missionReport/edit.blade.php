...
@section('content')
    ...
    <!--begin::Form-->
    <form class="form d-flex flex-column flex-lg-row report-form" action="{{ route('dashboard.report.update',['report'=>$report->id]) }}"
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 row">
                                    <div class="col-lg-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Editor-->
                                        <input class="form-control" value="{{ $report->name_ar }}"  name="name_ar"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Editor-->
                                        <input class="form-control" value="{{ $report->name_en }}"  name="name_en"
...
{{-- createReport.js --}}
    ...
    <script src="{{ asset('assets/js/datatables/updateReport.js') }}"></script>

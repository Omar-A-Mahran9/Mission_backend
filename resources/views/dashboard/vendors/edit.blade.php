            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">{{ __('Edit vendor') }}</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <form id="kt_account_profile_details_form" class="ajax-form" method="POST"
                        action="{{ route('dashboard.vendors.update', $vendor) }}"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-10 justify-content-center">
                                ...
                                <div class="col-md-2">
                                    <!--begin::Label-->
                                    <label
                                        class="form-label required fs-6 fw-bold mb-2 d-flex align-items-center">{{ __('Iban') }}</label>
                                    <!--end::Label-->
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline">
                                        <x-dashboard.upload-image-inp name="iban" :image="null" :directory="null"
                                            placeholder="default.svg" type="editable"></x-dashboard.upload-image-inp>
                                    </div>
                                    <!--end::Image input-->
                                    <!--begin::Hint-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="name" id="name_inp"
                                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                placeholder="{{ __('Full Name') }}" value="{{ $vendor->name }}" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <textarea class="form-control form-control-lg form-control-solid" name="description_ar" id="description_ar_inp"
                                        placeholder="{{ __('Description in Arabic') }}" data-kt-autosize="true">{{ $vendor->description_ar }}</textarea>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <textarea class="form-control form-control-lg form-control-solid" name="description_en" id="description_en_inp"
                                        placeholder="{{ __('Description in English') }}" data-kt-autosize="true">{{ $vendor->description_en }}</textarea>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="address" id="address_inp"
                                        ...
                                        placeholder="{{ __('Address') }}" value="{{ $vendor->address }}" />
                            ...
                            <div class="row mb-6">
                                ...
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                    <span class="required">{{ __("Owner's Phone Number") }}</span>
                                    <span class="ms-1" data-bs-toggle="tooltip"
                                        title="{{ __("The owner's main contact number for communication and verification.") }}">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <input type="tel" name="phone" id="phone_inp"
                                            ...
                                            placeholder="{{ __("Owner's Phone Number") }}"
                                            value="{{ $vendor->phone }}" />
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                    <span class="required">{{ __('Branch Contact Number') }}</span>
                                    <span class="ms-1" data-bs-toggle="tooltip"
                                        title="{{ __('The phone number to receive SMS notifications for new orders.') }}">
                                        <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                    </span>
                                </label>
                                <!--end::Label-->
                                ...
                                <div class="col-lg-8 fv-row">
                                    <div class="input-group input-group-solid mb-5">
                                        <span class="input-group-text">+966</span>
                                        <input type="tel" name="branch_number" id="branch_number_inp"
                                            class="form-control form-control-lg form-control-solid no-arrow"
                                            placeholder="{{ __('Branch Contact Number') }}"
                                            value="{{ $vendor->branch_number }}" />
                                        <div class="fv-plugins-message-container invalid-feedback" id="branch_number">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="commercial_register_number"
                                        ...
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('Commercial register number') }}"
                                        value="{{ $vendor->commercial_register_number }}" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="national_id" id="national_id_inp"
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('National ID') }}" value="{{ $vendor->national_id }}" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="iban_number" id="iban_number_inp"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="{{ __('Bank IBAN') }}" value="{{ $vendor->iban_number ?? '' }}" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="ratio[]" id="ratio_0_inp"
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('Gold') }}"
                                        value="{{ $vendor->categories[0]?->pivot->ratio ?? '' }}" step="0.01" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="ratio[]" id="ratio_1_inp"
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('Silver') }}"
                                        value="{{ $vendor->categories[1]?->pivot->ratio ?? '' }}" step="0.01" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="ratio[]" id="ratio_2_inp"
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('Diamond') }}"
                                        value="{{ $vendor->categories[2]?->pivot->ratio ?? '' }}" step="0.01" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="ratio[]" id="ratio_3_inp"
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('Watches') }}"
                                        value="{{ $vendor->categories[3]?->pivot->ratio ?? '' }}" step="0.01" />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="ratio[]" id="ratio_4_inp"
                                        class="form-control form-control-lg form-control-solid no-arrow"
                                        placeholder="{{ __('Alloys') }}"
                                        value="{{ $vendor->categories[4]?->pivot->ratio ?? '' }}" step="0.01" />
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#iban_inp').css('background-image', `url('${iban}')`);
        });
    </script>
@endpush

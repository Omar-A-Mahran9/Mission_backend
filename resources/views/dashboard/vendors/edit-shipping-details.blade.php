                    ...
                    <div class="d-flex flex-column flex-lg-row mb-17">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            ...
                            <form id="kt_careers_form" method="POST"
                                action="{{ route('dashboard.vendor.update.shipping-details', $vendor) }}"
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-md-3 fv-row">
                                        ...
                                        <input type="text" class="fform-control form-control-lg form-control"
                                            ...
                                            value="{{ $vendor->vendorShipment->name }}" id="name_inp" />
                                        <!--end::Input-->
                                    ...
                                    <div class="col-md-3 fv-row">
                                        ...
                                        <input type="text" name="phone"
                                            ...
                                            value="{{ $vendor->vendorShipment->phone }}" id="phone_inp"
                                    ...
                                    <div class="col-md-3 fv-row">
                                        ...
                                        <select class="form-select " data-control="select2" id="city_id_inp"
                                            ...
                                            @foreach ($cities as $city)
                                                <option
                                                    value="{{ $city->id }}"{{ $city->id == $vendor->vendorShipment->city_id ? 'selected' : '' }}>
                                                    {{ $city->name }} </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3 fv-row">
                                        ...
                                        <input type="text" class="fform-control form-control-lg form-control"
                                            ...
                                            value="{{ $vendor->vendorShipment->country_code }}" id="country_code_inp" />
                                        <!--end::Input-->
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <input type="text" class="fform-control form-control-lg form-control"
                                            ...
                                            value="{{ $vendor->vendorShipment->street_address }}"
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <input type="text" class="fform-control form-control-lg form-control"
                                            ...
                                            value="{{ $vendor->vendorShipment->contact_name }}" id="contact_name_inp" />
                                        <!--end::Input-->
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <input type="text" class="fform-control form-control-lg form-control"
                                            ...
                                            value="{{ $vendor->vendorShipment->contact_email }}" id="contact_email_inp" />
                                        <!--end::Input-->
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <input type="hidden" id="lat_inp" value="{{ $vendor->vendorShipment->lat }}"
                                                name="lat">
                                            <input type="hidden" id="lng_inp"
                                                value="{{ $vendor->vendorShipment->long }}" name="lng">
...
@push('scripts')
    <script>
        ...
        let lng = 46.6753;
        if (vendor) {
            lat = +vendor.vendor_shipment.lat;
            lng = +vendor.vendor_shipment.long;
        }
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDu4T0sSqqn87uvqXHcUbbWpxt4NVyBW6w&loading=async&libraries=drawing&callback=myMap&&language=ar&region=EG">
    </script>
@endpush

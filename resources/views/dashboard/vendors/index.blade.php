            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-20" placeholder="{{ __('Search for vendors') }}">
                    <select class="form-select form-select-solid w-200px ps-40 filter-datatable-inp ms-2"
                        data-filter-index="3" data-dir="@if (isArabic()) rtl @else ltr @endif"
                        name="approved" id="approved_inp" data-control="select2" data-allow-clear="true"
                        data-placeholder="{{ __('Select status') }}">
                        <option></option>
                        @foreach (App\Enums\VendorStatusEnum::values() as $key => $value)
                            <option value="{{ $key }}">{{ __('' . $value) }}</option>
                        @endforeach
                    </select>
                    <select class="form-select form-select-solid w-200px ps-40 filter-datatable-inp ms-2"
                        data-filter-index="5" data-dir="@if (isArabic()) rtl @else ltr @endif"
                        name="status" id="status_inp" data-control="select2" data-allow-clear="true"
                        data-placeholder="{{ __('Suspended Status') }}">
                        <option></option>
                ...
                <!--begin::Toolbar-->
                <!--begin::Add customer-->
                <a class="d-flex justify-content-end btn btn-primary" href="{{ route('dashboard.vendors.create') }}"
            ...
            <table id="kt_datatable" class="table align-middle text-center table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class=" text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th style="text-align: center; width: 219.25px;">{{ __('Name') }}</th>
                        <th style="text-align: center; width: 219.25px;">{{ __('Business Id') }}</th>
                        <th style="text-align: center; width: 219.25px;">{{ __('Email') }}</th>
                        <th style="text-align: center; width: 219.25px;">{{ __('Status') }}</th>
                        <th style="text-align: center; width: 219.25px;">{{ __('Created at') }}</th>
                        <th style="text-align: center; width: 219.25px;" class=" min-w-100px">{{ __('Actions') }}</th>
                    </tr>
                </thead>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg form-control"
                            id="name_inp" placeholder="{{ __('Vendor name') }}">
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <input type="text" name="email" autocomplete="new-password"
                            class="form-control form-control-lg form-control" id="email_inp"
                            placeholder="{{ __('Vendor email') }}">
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <input type="text" name="phone" class="form-control form-control-lg form-control"
                            id="phone_inp" placeholder="0xxxxxxxx">
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <select class="form-select form-select" data-control="select2" name="subscription_id"
                            id="subscription-sp" data-placeholder="{{ __('Choose the subscription') }}"
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <div class="input-group" id="kt_td_picker_basic" data-td-target-input="nearest"
                            ...
                            <input id="kt_td_picker_basic_input" type="text" name="subscription_end_date"
                                id="subscription_end_date_inp" placeholder="{{ __('Pick date & time') }}"
                                class="form-control form-control-lg " data-td-target="#kt_td_picker_basic" />
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <div class="position-relative mb-3" data-kt-password-meter="true">
                            <input class="form-control form-control-lg form-control" type="password" name="password"
                                autocomplete="new-password" id="password_inp" placeholder="{{ __('Password') }}" />
                    ...
                    <div class="fv-row mb-2 fv-plugins-icon-container">
                        ...
                        <!--begin::Input wrapper-->
                        <div class="position-relative mb-3" data-kt-password-meter="true">
                            <input class="form-control form-control-lg form-control" type="password"

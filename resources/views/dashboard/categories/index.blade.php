                        ...
                        @if (request('type') === 'sub')
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="me-5">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold">{{ __('size applicable') }}</label>
                                        <!--end::Label-->
                                    ...
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input" name="size_applicable" type="checkbox"
                                            value="1" id="kt_modal_update_address_billing">
                                        <!--end::Input-->
                                    </label>
                                    <!--end::Switch-->
                                </div>
                                <div class="fv-plugins-message-container invalid-feedback" id="size_applicable">
                                </div>
                            </div>
                        @endif
                        @if (request('type') === 'parent')
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="me-5">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold">{{ __('Tax applicable?') }}</label>
                                        <!--end::Label-->
                                    ...
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input" name="tax_applicable" type="checkbox"
                                            value="1" id="kt_modal_update_address_billing">
                                        <!--end::Input-->
                                    </label>
                                    <!--end::Switch-->
                                </div>
                                <div class="fv-plugins-message-container invalid-feedback" id="tax_applicable">
                                </div>
                            </div>
                        @endif
                    </div>

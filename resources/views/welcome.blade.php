    ...
    <div id="kt_app_content" class="app-content pt-4">
        ...
        <div class="app-toolbar-wrapper w-100 mb-8">
            ...
            <div class="d-flex flex-stack mb-2">
                <!--begin::Title-->
                <span class="fw-bold fs-5 text-gray-700">Topic Categories</span>
                <!--end::Title-->
                <!--begin::Action-->
            ...
            <!--end::Wrapper-->
            <!--begin::Navs-->
            <div class="nav d-flex justify-content-xxl-between flex-wrap gap-5">
                <!--begin::Nav item-->
                <li class="nav-item mb-2">
                    <!--begin::Nav link-->
                    <a class="nav-link btn btn-active-success btn-center bg-gray-100 btn-color-gray-600 rounded-3 flex-column overflow-hidden w-90px h-85px pt-7 pt-lg-5 pb-2 active"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Blue to
                                                        Orange Art</a>
